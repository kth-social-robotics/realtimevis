function [gaze, mocap, maxGazeStartTime, minEndTime] =  sync_gaze_and_mocap(gaze_syncfiles, gaze_masteraudio, mocap_syncfile, mocap_data, gaze_data, appstart, resampleFrameRate, nsec, gazesync_method, mocapsync_method)
...
%             figure; plot(Xg)
    ...
    % Use app instead of maxStartTime. It will start 10 seconds before the
    % app starts
